      ...
      >
        ...
        <div
          className="absolute top-0 left-0 w-full h-full bg-black/70
            z-10"
        />
        <h1 className="text-white text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bricolage z-20 leading-tight px-4">
          Properties
        </h1>
        <h1 className="text-white text-xs sm:text-sm md:text-base lg:text-lg font-bold font-bricolage mt-2 sm:mt-3 md:mt-4 z-20 px-4">
